...
let SupplierService = class SupplierService {
    ...
    async findSupplierList(query, body) {
    ...
    async findSupplierById(param) {
        ...
        if (queryBuild !== undefined) {
            ...
            throw new common_1.HttpException("Supplier Not Found!", common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    async updatedSupplier(param, body) {
    ...
    async updateSupplierStatus(param, body) {
        const result = await this.supplierRepo.update({ id: param.id }, body).catch(err => {
            throw new common_1.HttpException(err.message, common_1.HttpStatus.BAD_REQUEST);
        });
        if (result.affected !== 0) {
    ...
    async updateSupplierBulkStatus(body1, body2) {
        const queryBuild = await this.supplierRepo
            .createQueryBuilder()
            .update(supplier_entity_1.Supplier)
            .set({
