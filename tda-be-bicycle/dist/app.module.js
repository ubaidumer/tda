...
const bicycle_type_module_1 = require("./api/bicycle-type/bicycle-type.module");
const bicycle_frame_module_1 = require("./api/bicycle-frame/bicycle-frame.module");
const bicycle_attribute_detail_module_1 = require("./api/bicycle-attribute-detail/bicycle-attribute-detail.module");
const bicycle_attribute_module_1 = require("./api/bicycle-attribute/bicycle-attribute.module");
...
AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            bicycle_type_module_1.BicycleTypeModule,
            bicycle_frame_module_1.BicycleFrameModule,
            bicycle_attribute_detail_module_1.BicycleAttributeDetailModule,
            bicycle_attribute_module_1.BicycleAttributeModule
        ],
