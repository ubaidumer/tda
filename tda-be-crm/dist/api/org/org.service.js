...
let OrgService = class OrgService {
    ...
    async findOrgById(param) {
        ...
        if (queryBuild !== undefined) {
            ...
            throw new common_1.HttpException("Org Not Found!", common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    async updateOrgStatus(param, body) {
    ...
    async updateOrgBulkStatus(body1, body2) {
        const queryBuild = await this.orgRepo
            .createQueryBuilder()
            .update(org_entity_1.Org)
            .set({
...
OrgService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(org_entity_1.Org)),
