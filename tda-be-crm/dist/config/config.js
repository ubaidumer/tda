...
const client_entity_1 = require("../api/client/client.entity");
const employee_entity_1 = require("../api/employee/employee.entity");
const org_entity_1 = require("../api/org/org.entity");
const orgtype_entity_1 = require("../api/orgtype/orgtype.entity");
const tag_entity_1 = require("../api/tag/tag.entity");
dotenv.config();
const CONFIG = {
    ...
    DATABASE_ENTITIES: [tag_entity_1.Tag, orgtype_entity_1.Orgtype, client_entity_1.Client, employee_entity_1.Employee, org_entity_1.Org],
