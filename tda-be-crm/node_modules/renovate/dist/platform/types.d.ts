...
declare type VulnerabilityKey = string;
declare type VulnerabilityRangeKey = string;
declare type VulnerabilityPatch = string;
export declare type AggregatedVulnerabilities = Record<VulnerabilityKey, Record<VulnerabilityRangeKey, VulnerabilityPatch>>;
...
export declare type GitUrlOption = 'default' | 'ssh' | 'endpoint';
...
export declare type PlatformPrOptions = {
...
export declare type EnsureIssueResult = 'updated' | 'created';
export interface Platform {
    ...
    getJsonFile(fileName: string, repoName?: string, branchOrTag?: string): Promise<any | null>;
    ...
    getBranchStatusCheck(branchName: string, context: string): Promise<BranchStatus | null>;
