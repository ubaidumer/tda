...
export declare function initPlatform({ endpoint, token, username, gitAuthor, }: PlatformParams): Promise<PlatformResult>;
...
export declare function initRepo({ endpoint, repository, forkMode, forkToken, renovateUsername, cloneSubmodules, ignorePrAuthor, }: RepoParams): Promise<RepoResult>;
...
export declare function createPr({ sourceBranch, targetBranch, prTitle: title, prBody: rawBody, labels, draftPR, platformOptions, }: CreatePRConfig): Promise<Pr>;
