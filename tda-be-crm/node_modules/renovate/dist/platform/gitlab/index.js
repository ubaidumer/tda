...
async function initPlatform({ endpoint, token, gitAuthor, }) {
    ...
    draftPrefix = (0, semver_1.lt)(defaults.version, '13.2.0')
...
async function ignoreApprovals(pr) {
    try {
        ...
        const zeroApproversRule = rules === null || rules === void 0 ? void 0 : rules.find(({ name }) => name === ruleName);
...
async function tryPrAutomerge(pr, platformOptions) {
    if (platformOptions === null || platformOptions === void 0 ? void 0 : platformOptions.usePlatformAutomerge) {
        try {
            if (platformOptions === null || platformOptions === void 0 ? void 0 : platformOptions.gitLabIgnoreApprovals) {
...
async function getPr(iid) {
    ...
    const pr = {
        ...
        hasAssignees: !!(((_a = mr.assignee) === null || _a === void 0 ? void 0 : _a.id) || ((_c = (_b = mr.assignees) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.id)),
        hasReviewers: !!((_d = mr.reviewers) === null || _d === void 0 ? void 0 : _d.length),
        title: mr.title,
        labels: mr.labels,
        sha: mr.sha,
    };
...
function massageMarkdown(input) {
    ...
    if ((0, semver_1.lt)(defaults.version, '13.4.0')) {
        ...
        desc = (0, pr_body_1.smartTruncate)(desc, 25000);
    }
    else {
        desc = (0, pr_body_1.smartTruncate)(desc, 1000000);
    }
    return desc;
}
            ...
            if (issue.title !== title || existingDescription !== description) {
                ...
                await http_1.gitlabApi.putJson(`projects/${config.repository}/issues/${issue.iid}`, {
                    body: {
                        ...
                        confidential: confidential !== null && confidential !== void 0 ? confidential : false,
                    },
                });
                return 'updated';
            }
...
async function addAssignees(iid, assignees) {
    ...
    try {
        let assigneeId = await (0, http_1.getUserID)(assignees[0]);
        ...
        try {
            if (assignees.length > 1) {
                ...
                for (let i = 1; i < assignees.length; i += 1) {
                    assigneeId = await (0, http_1.getUserID)(assignees[i]);
...
async function addReviewers(iid, reviewers) {
    ...
    if ((0, semver_1.lt)(defaults.version, '13.9.0')) {
    ...
    mr.reviewers = (_a = mr.reviewers) !== null && _a !== void 0 ? _a : [];
