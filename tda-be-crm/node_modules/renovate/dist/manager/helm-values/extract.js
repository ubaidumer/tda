...
function findDependencies(parsedContent, packageDependencies) {
    ...
    Object.keys(parsedContent).forEach((key) => {
        if ((0, util_1.matchesHelmValuesDockerHeuristic)(key, parsedContent[key])) {
        ...
        else if ((0, util_1.matchesHelmValuesInlineImage)(key, parsedContent[key])) {
            const currentItem = parsedContent[key];
            packageDependencies.push((0, extract_1.getDep)(currentItem));
        }
        else {
