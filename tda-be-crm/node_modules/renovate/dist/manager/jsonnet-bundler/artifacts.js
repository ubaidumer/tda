...
function dependencyUrl(dep) {
    ...
    if ((_a = dep.managerData) === null || _a === void 0 ? void 0 : _a.subdir) {
...
async function updateArtifacts(updateArtifact) {
    ...
    const jsonnetBundlerToolConstraint = {
        toolName: 'jb',
        constraint: (_a = config.constraints) === null || _a === void 0 ? void 0 : _a.jb,
    };
    const execOptions = {
    ...
    try {
        ...
        const res = [];
        for (const f of (_b = status.modified) !== null && _b !== void 0 ? _b : []) {
            res.push({
                file: {
                    name: f,
        ...
        for (const f of (_c = status.not_added) !== null && _c !== void 0 ? _c : []) {
            res.push({
                file: {
                    name: f,
                    contents: await (0, fs_1.readLocalFile)(f),
        ...
        for (const f of (_d = status.deleted) !== null && _d !== void 0 ? _d : []) {
            res.push({
                file: {
                    name: '|delete|',
                    contents: f,
