...
export declare function getComposerArguments(config: UpdateArtifactsConfig): string;
export declare function getPhpConstraint(constraints: Record<string, string>): string;
