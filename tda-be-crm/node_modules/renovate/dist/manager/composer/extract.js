...
function transformRegUrl(url) {
    return url.replace((0, regex_1.regEx)(/(\/packages\.json)$/), ''); // TODO #12071
}
/**
            ...
            try {
                for (const [depName, version] of Object.entries(composerJson[depType])) {
                    ...
                    if (lockParsed) {
                        ...
                        const lockedDep = (_a = lockParsed[lockField]) === null || _a === void 0 ? void 0 : _a.find((item) => item.name === dep.depName);
                        if (lockedDep && composer_1.api.isVersion(lockedDep.version)) {
                            dep.lockedVersion = lockedDep.version.replace((0, regex_1.regEx)(/^v/i), ''); // TODO #12071
                        }
                    }
                    deps.push(dep);
                }
