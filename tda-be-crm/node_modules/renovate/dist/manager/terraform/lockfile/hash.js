...
const extract_zip_1 = (0, tslib_1.__importDefault)(require("extract-zip"));
...
const fs = (0, tslib_1.__importStar)(require("../../../util/fs"));
...
class TerraformProviderHash {
    static async hashFiles(files) {
        ...
        for (const file of files) {
            ...
            rootHash.update('  ');
            const fileName = file.replace((0, regex_1.regEx)(/^.*[\\/]/), ''); // TODO #12071
