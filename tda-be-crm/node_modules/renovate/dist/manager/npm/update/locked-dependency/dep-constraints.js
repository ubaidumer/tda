...
function findDepConstraints(packageJson, lockEntry, depName, currentVersion, newVersion, parentDepName) {
    var _a, _b;
    let parents = [];
    let packageJsonConstraint = (_a = packageJson.dependencies) === null || _a === void 0 ? void 0 : _a[depName];
    ...
    packageJsonConstraint = (_b = packageJson.devDependencies) === null || _b === void 0 ? void 0 : _b[depName];
    if (packageJsonConstraint) {
        parents.push({
