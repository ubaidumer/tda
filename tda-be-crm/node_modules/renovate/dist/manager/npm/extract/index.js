...
const nodeVersioning = (0, tslib_1.__importStar)(require("../../../versioning/node"));
...
function parseDepName(depType, key) {
    ...
    const [, depName] = (_a = (0, regex_1.regEx)(/((?:@[^/]+\/)?[^/@]+)$/).exec(key)) !== null && _a !== void 0 ? _a : [];
    return depName;
}
...
async function extractPackageFile(content, fileName, config) {
    ...
    if (is_1.default.string(repoNpmrc)) {
        if (is_1.default.string(config.npmrc) && !config.npmrcMerge) {
            ...
            if (repoNpmrc === null || repoNpmrc === void 0 ? void 0 : repoNpmrc.includes('package-lock')) {
