...
const semver_1 = (0, tslib_1.__importStar)(require("semver"));
...
async function generateLockFiles(lernaPackageFile, cwd, config, env, skipInstalls) {
    ...
    try {
        if (lernaClient === 'yarn') {
            ...
            if ((0, semver_1.validRange)(yarnCompatibility)) {
            ...
            const npmCompatibility = (_b = config.constraints) === null || _b === void 0 ? void 0 : _b.npm;
            if ((0, semver_1.validRange)(npmCompatibility)) {
