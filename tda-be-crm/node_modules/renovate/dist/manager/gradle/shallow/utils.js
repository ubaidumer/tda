...
exports.getVars = exports.reorderFiles = exports.toAbsolutePath = exports.isTOMLFile = exports.isPropsFile = exports.isGradleFile = exports.isGradleBuildFile = exports.isGradleVersionsFile = exports.interpolateString = exports.parseDependencyString = exports.isDependencyString = exports.versionLikeSubstring = void 0;
...
function isDependencyString(input) {
    ...
    if (tempVersionPart !== versionLikeSubstring(tempVersionPart) &&
        ...
        const versionSplit = tempVersionPart === null || tempVersionPart === void 0 ? void 0 : tempVersionPart.split('@');
        if ((versionSplit === null || versionSplit === void 0 ? void 0 : versionSplit.length) !== 2) {
            return false;
        }
...
const gradleFileRegex = (0, regex_1.regEx)('\\.gradle(?:\\.kts)?$', 'i');
