...
const execute_post_upgrade_commands_1 = (0, tslib_1.__importDefault)(require("./execute-post-upgrade-commands"));
...
function rebaseCheck(config, branchPr) {
    var _a, _b, _c;
    const titleRebase = (_a = branchPr.title) === null || _a === void 0 ? void 0 : _a.startsWith('rebase!');
    const labelRebase = (_b = branchPr.labels) === null || _b === void 0 ? void 0 : _b.includes(config.rebaseLabel);
    const prRebaseChecked = (_c = branchPr.body) === null || _c === void 0 ? void 0 : _c.includes(`- [x] <!-- rebase-check -->`);
...
async function processBranch(branchConfig) {
    ...
    const branchExists = (0, git_1.branchExists)(config.branchName);
    let branchPr = await platform_1.platform.getBranchPr(config.branchName);
    logger_1.logger.debug(`branchExists=${branchExists}`);
    const dependencyDashboardCheck = (_a = config.dependencyDashboardChecks) === null || _a === void 0 ? void 0 : _a[config.branchName];
    ...
    try {
        ...
        if (!branchExists && config.dependencyDashboardApproval) {
            if (dependencyDashboardCheck) {
                ...
                return {
                    branchExists,
                    prNo: branchPr === null || branchPr === void 0 ? void 0 : branchPr.number,
            ...
            if (branchPr) {
                ...
                if (branchIsModified ||
                    ...
                    if (dependencyDashboardCheck || config.rebaseRequested) {
                        ...
                        const newBody = (_b = branchPr.body) === null || _b === void 0 ? void 0 : _b.replace(rebasingRegex, '**Rebasing**: Renovate will not automatically rebase this PR, because other commits have been found.');
                ...
                const oldPrSha = oldPr === null || oldPr === void 0 ? void 0 : oldPr.sha;
        ...
        // Check schedule
        config.isScheduledNow = (0, schedule_1.isScheduledNow)(config);
        ...
        config = { ...config, ...res };
        if ((_c = config.updatedPackageFiles) === null || _c === void 0 ? void 0 : _c.length) {
        ...
        if ((_d = config.updatedArtifacts) === null || _d === void 0 ? void 0 : _d.length) {
            logger_1.logger.debug({
                updatedArtifacts: config.updatedArtifacts.map((f) => f.name === '|delete|' ? `${String(f.contents)} (delete)` : f.name),
        ...
        if ((_e = config.artifactErrors) === null || _e === void 0 ? void 0 : _e.length) {
        ...
        else if (((_f = config.updatedArtifacts) === null || _f === void 0 ? void 0 : _f.length) && branchPr) {
        ...
        const forcedManually = !!dependencyDashboardCheck || config.rebaseRequested || !branchExists;
        if (!forcedManually && config.rebaseWhen === 'never') {
            logger_1.logger.debug(`Skipping commit (rebaseWhen=never)`);
            return {
                branchExists,
                prNo: branchPr === null || branchPr === void 0 ? void 0 : branchPr.number,
        ...
        config.forceCommit = forcedManually || (branchPr === null || branchPr === void 0 ? void 0 : branchPr.isConflicted);
        ...
        if (!((_g = config.artifactErrors) === null || _g === void 0 ? void 0 : _g.length) &&
            !dependencyDashboardCheck &&
        ...
        if ((_h = err.message) === null || _h === void 0 ? void 0 : _h.startsWith('remote: Invalid username or password')) {
            logger_1.logger.debug('Throwing bad credentials');
            throw new Error(error_messages_1.PLATFORM_BAD_CREDENTIALS);
        }
        if ((_j = err.message) === null || _j === void 0 ? void 0 : _j.startsWith('ssh_exchange_identification: Connection closed by remote host')) {
            logger_1.logger.debug('Throwing bad credentials');
            throw new Error(error_messages_1.PLATFORM_BAD_CREDENTIALS);
        }
        ...
        if ((_k = err.message) === null || _k === void 0 ? void 0 : _k.includes('space left on device')) {
        ...
        else if ((_l = err.message) === null || _l === void 0 ? void 0 : _l.includes('fatal: bad revision')) {
        ...
        return { branchExists, prNo: branchPr === null || branchPr === void 0 ? void 0 : branchPr.number, result: types_2.BranchResult.Error };
    }
    try {
        ...
        const { prBlockedBy, pr } = await (0, pr_1.ensurePr)(config);
        branchPr = pr;
        if (prBlockedBy) {
        ...
        if (pr) {
            if ((_m = config.artifactErrors) === null || _m === void 0 ? void 0 : _m.length) {
                ...
                if (prAutomergeResult === null || prAutomergeResult === void 0 ? void 0 : prAutomergeResult.automerged) {
    ...
    return { branchExists, prNo: branchPr === null || branchPr === void 0 ? void 0 : branchPr.number, result: types_2.BranchResult.Done };
}
