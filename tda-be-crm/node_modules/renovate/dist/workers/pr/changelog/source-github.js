...
async function getChangeLogJSON({ versioning, currentVersion, newVersion, sourceUrl, sourceDirectory, releases, depName, manager, }) {
    ...
    async function getRef(release) {
        ...
        const regex = (0, regex_1.regEx)(`(?:${depName}|release)[@-]`);
        const tagName = tags
    ...
    res = await (0, release_notes_1.addReleaseNotes)(res);
    return res;
}
