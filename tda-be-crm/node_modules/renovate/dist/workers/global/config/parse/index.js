...
const defaultsParser = (0, tslib_1.__importStar)(require("../../../../config/defaults"));
const utils_1 = require("../../../../config/utils");
const logger_1 = require("../../../../logger");
const manager_1 = require("../../../../manager");
const fs_1 = require("../../../../util/fs");
const url_1 = require("../../../../util/url");
const cliParser = (0, tslib_1.__importStar)(require("./cli"));
const envParser = (0, tslib_1.__importStar)(require("./env"));
const fileParser = (0, tslib_1.__importStar)(require("./file"));
