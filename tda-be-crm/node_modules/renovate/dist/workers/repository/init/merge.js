...
const json_dup_key_validator_1 = (0, tslib_1.__importDefault)(require("json-dup-key-validator"));
...
const presets = (0, tslib_1.__importStar)(require("../../../config/presets"));
const secrets_1 = require("../../../config/secrets");
const error_messages_1 = require("../../../constants/error-messages");
const npmApi = (0, tslib_1.__importStar)(require("../../../datasource/npm"));
...
async function mergeRenovateConfig(config) {
    ...
    const decryptedConfig = await (0, decrypt_1.decryptConfig)(migratedConfig, config.repository);
    // istanbul ignore if
    ...
    let resolvedConfig = await (0, decrypt_1.decryptConfig)(await presets.resolveConfigPresets(decryptedConfig, config), config.repository);
