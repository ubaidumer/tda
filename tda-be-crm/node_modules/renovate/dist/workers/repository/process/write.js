...
async function writeUpdates(config, allBranches) {
    ...
    for (const branch of branches) {
        ...
        branch.prBlockedBy = res === null || res === void 0 ? void 0 : res.prBlockedBy;
        branch.prNo = res === null || res === void 0 ? void 0 : res.prNo;
        branch.result = res === null || res === void 0 ? void 0 : res.result;
