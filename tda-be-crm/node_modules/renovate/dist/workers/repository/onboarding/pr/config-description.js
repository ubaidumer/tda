...
const dist_1 = (0, tslib_1.__importDefault)(require("@sindresorhus/is/dist"));
...
function getConfigDesc(config, packageFiles) {
    ...
    desc += '\n';
    desc += (0, emoji_1.emojify)(`:abcd: Would you like to change the way Renovate is upgrading your dependencies?`);
