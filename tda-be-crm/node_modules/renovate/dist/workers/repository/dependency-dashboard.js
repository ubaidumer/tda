...
async function ensureDependencyDashboard(config, branches) {
    var _a, _b, _c, _d;
    // legacy/migrated issue
    const reuseTitle = 'Update Dependencies (Renovate Bot)';
    if (!(config.dependencyDashboard ||
        config.dependencyDashboardApproval ||
        ((_a = config.packageRules) === null || _a === void 0 ? void 0 : _a.some((rule) => rule.dependencyDashboardApproval)) ||
    ...
    const hasBranches = is_1.default.nonEmptyArray(branches) &&
        branches.some((branch) => branch.result !== types_1.BranchResult.Automerged);
    ...
    let issueBody = '';
    if ((_b = config.dependencyDashboardHeader) === null || _b === void 0 ? void 0 : _b.length) {
    ...
    if ((_c = config.dependencyDashboardFooter) === null || _c === void 0 ? void 0 : _c.length) {
        issueBody += `---\n${config.dependencyDashboardFooter}\n`;
    }
    if (config.dependencyDashboardIssue) {
        const updatedIssue = await ((_d = platform_1.platform.getIssue) === null || _d === void 0 ? void 0 : _d.call(platform_1.platform, config.dependencyDashboardIssue, false));
        if (updatedIssue) {
