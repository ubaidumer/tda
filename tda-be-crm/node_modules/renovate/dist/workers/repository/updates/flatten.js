...
function sanitizeDepName(depName) {
    return depName
        .replace('@types/', '')
        .replace('@', '')
        .replace((0, regex_1.regEx)(/\//g), '-') // TODO #12071
...
function applyUpdateConfig(input) {
    ...
    if (updateConfig.sourceUrl) {
        ...
        if (parsedSourceUrl === null || parsedSourceUrl === void 0 ? void 0 : parsedSourceUrl.pathname) {
            updateConfig.sourceRepoSlug = parsedSourceUrl.pathname
                .replace((0, regex_1.regEx)(/^\//), '') // remove leading slash  // TODO #12071
                .replace((0, regex_1.regEx)(/\//g), '-') // change slashes to hyphens   // TODO #12071
        ...
        for (const packageFile of files) {
            ...
            if ((0, manager_1.get)(manager, 'updateLockedDependency')) {
                for (const lockFile of packageFileConfig.lockFiles || []) {
                    const remediations = (_b = config.remediations) === null || _b === void 0 ? void 0 : _b[lockFile];
                    if (remediations) {
