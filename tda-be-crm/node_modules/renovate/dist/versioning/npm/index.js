...
const isSingleVersion = (constraint) => (0, exports.isVersion)(constraint) ||
    ((constraint === null || constraint === void 0 ? void 0 : constraint.startsWith('=')) && (0, exports.isVersion)(constraint.substring(1).trim()));
exports.api = {
    equals,
    getMajor,
    getMinor,
