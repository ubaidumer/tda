...
const getMajor = (version) => {
    if ((0, compare_1.isVersion)(version)) {
        const tokens = (0, compare_1.tokenize)(version.replace((0, regex_1.regEx)(/^v/i), ''));
        const majorToken = tokens === null || tokens === void 0 ? void 0 : tokens[0];
...
const matches = (a, b) => {
    if (!a || !(0, compare_1.isVersion)(a) || !b) {
        return false;
    }
    ...
    if (prefixRange) {
        ...
        const versionTokens = (0, compare_1.tokenize)(a);
