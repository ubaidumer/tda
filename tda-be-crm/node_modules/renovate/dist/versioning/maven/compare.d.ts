...
export declare function qualifierType(token: Token): number;
...
declare function parseRange(rangeStr: string): Range[];
...
declare function rangeToStr(fullRange: Range[]): string | null;
