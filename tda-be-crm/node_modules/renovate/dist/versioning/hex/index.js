...
function hex2npm(input) {
    return input
        .replace((0, regex_1.regEx)(/~>\s*(\d+\.\d+)$/), '^$1') // TODO #12071
        .replace((0, regex_1.regEx)(/~>\s*(\d+\.\d+\.\d+)/), '~$1') // TODO #12071
        .replace((0, regex_1.regEx)(/==|and/), '') // TODO #12071
        .replace('or', '||')
        .replace((0, regex_1.regEx)(/!=\s*(\d+\.\d+(\.\d+.*)?)/), '>$1 <$1') // TODO #12071
        .trim();
}
