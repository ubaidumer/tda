...
const cmd_serializer_1 = (0, tslib_1.__importDefault)(require("./cmd-serializer"));
const config_serializer_1 = (0, tslib_1.__importDefault)(require("./config-serializer"));
const err_serializer_1 = (0, tslib_1.__importDefault)(require("./err-serializer"));
const pretty_stdout_1 = require("./pretty-stdout");
const utils_1 = require("./utils");
let logContext = (_a = process.env.LOG_CONTEXT) !== null && _a !== void 0 ? _a : (0, nanoid_1.nanoid)();
let curMeta = {};
