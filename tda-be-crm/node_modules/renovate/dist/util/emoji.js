...
const emoji_1 = (0, tslib_1.__importDefault)(require("emojibase-regex/emoji"));
const shortcode_1 = (0, tslib_1.__importDefault)(require("emojibase-regex/shortcode"));
const data_files_generated_1 = (0, tslib_1.__importDefault)(require("../data-files.generated"));
...
const shortCodeRegex = (0, regex_1.regEx)(shortcode_1.default.source, 'g');
...
const emojiRegexSrc = [emoji_1.default, (0, emoji_regex_1.default)()].map(({ source }) => source);
