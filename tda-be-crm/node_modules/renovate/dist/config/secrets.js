...
function replaceSecretsinObject(config_, secrets = {}) {
        ...
        if (is_1.default.array(value)) {
            for (const [arrayIndex, arrayItem] of value.entries()) {
                if (is_1.default.plainObject(arrayItem)) {
                    ...
                    config[key][arrayIndex] = replaceSecretsInString(key, arrayItem, secrets);
                }
            }
        }
    }
...
function applySecretsToConfig(config, secrets = config.secrets) {
    // Add all secrets to be sanitized
    if (is_1.default.plainObject(secrets)) {
        for (const secret of Object.values(secrets)) {
            (0, sanitize_1.add)(String(secret));
        }
    }
