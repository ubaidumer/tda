...
const openpgp = (0, tslib_1.__importStar)(require("openpgp"));
...
async function tryDecrypt(privateKey, encryptedStr, repository) {
    let decryptedStr = null;
    if (privateKey === null || privateKey === void 0 ? void 0 : privateKey.startsWith('-----BEGIN PGP PRIVATE KEY BLOCK-----')) {
