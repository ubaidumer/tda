...
const dockerVersioning = (0, tslib_1.__importStar)(require("../../versioning/docker"));
const pep440Versioning = (0, tslib_1.__importStar)(require("../../versioning/pep440"));
const options = [
    {
        name: 'detectGlobalManagerConfig',
        description: 'If true, Renovate will attempt to read global manager config from the file system.',
        type: 'boolean',
        default: false,
        globalOnly: true,
    },
    ...
    },
    {
        ...
        description: 'Change this value in order to add a prefix to the Renovate Docker sidecar container names and labels.',
        type: 'string',
        globalOnly: true,
        default: 'renovate_',
    },
    ...
    },
    {
        ...
        description: 'Configure use of `--ignore-platform-reqs`/`--ignore-platform-req` for the Composer package manager.',
        type: 'array',
        subType: 'string',
        default: [],
    },
    ...
    {
        name: 'forkToken',
        description: 'Will be used on GitHub when `forkMode` is set to `true` to clone the repositories.',
        stage: 'repository',
        type: 'string',
        default: '',
        globalOnly: true,
    ...
    {
        name: 'requireConfig',
        description: 'Set to false if it is optional for repositories to contain a config.',
        stage: 'repository',
        type: 'boolean',
        default: true,
        globalOnly: true,
    ...
    },
    {
        ...
        type: 'string',
        default: 'This issue provides visibility into Renovate updates and their statuses. [Learn more](https://docs.renovatebot.com/key-concepts/dashboard/)',
    },
    {
    ...
    {
        name: 'exposeAllEnv',
        description: 'Configure this to true to allow passing of all env variables to package managers.',
        globalOnly: true,
        type: 'boolean',
        default: false,
    },
    {
        name: 'allowPlugins',
        description: 'Configure this to true if repositories are allowed to run install plugins.',
        globalOnly: true,
        type: 'boolean',
        default: false,
    },
    {
        name: 'allowScripts',
        description: 'Configure this to true if repositories are allowed to run install scripts.',
        globalOnly: true,
        type: 'boolean',
        default: false,
    },
    {
        ...
        description: 'Configure this to true if custom crate registries are allowed.',
        globalOnly: true,
        type: 'boolean',
        default: false,
    },
    {
        name: 'ignorePlugins',
        description: 'Configure this to true if allowPlugins=true but you wish to skip running plugins when updating lock files.',
        type: 'boolean',
        default: false,
    },
    {
        name: 'ignoreScripts',
        description: 'Configure this to true if allowScripts=true but you wish to skip running scripts when updating lock files.',
        type: 'boolean',
        default: false,
...
function loadManagerOptions() {
    for (const [name, config] of (0, manager_1.getManagers)().entries()) {
