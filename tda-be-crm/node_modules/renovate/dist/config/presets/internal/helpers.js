...
exports.presets = {
    ...
    followTypescriptNext: {
        description: 'Keep <code>typescript</code> version in sync with the <code>next</code> tag',
        extends: [':followTag(typescript, next)'],
    },
    followTypescriptRc: {
        description: 'Keep <code>typescript</code> version in sync with the <code>rc</code> tag',
