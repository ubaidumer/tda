...
export declare type RenovateConfigStage = 'global' | 'repository' | 'package' | 'branch' | 'pr';
export declare type RepositoryCacheConfig = 'disabled' | 'enabled' | 'reset';
...
export declare type ExecutionMode = 'branch' | 'update';
export declare type PostUpgradeTasks = {
    commands?: string[];
    fileFilters?: string[];
    executionMode: ExecutionMode;
};
declare type UpdateConfig<T extends RenovateSharedConfig = RenovateSharedConfig> = Partial<Record<UpdateType, T>>;
export declare type RenovateRepository = string | {
    repository: string;
...
export interface RenovateConfig extends LegacyAdminConfig, RenovateSharedConfig, UpdateConfig<PackageRule>, AssigneesAndReviewersConfig, Record<string, unknown> {
    depName?: string;
    baseBranches?: string[];
    baseBranch?: string;
...
export declare type UpdateType = 'major' | 'minor' | 'patch' | 'pin' | 'digest' | 'lockFileMaintenance' | 'lockfileUpdate' | 'rollback' | 'bump' | 'replacement';
export declare type MatchStringsStrategy = 'any' | 'recursive' | 'combination';
export declare type MergeStrategy = 'auto' | 'fast-forward' | 'merge-commit' | 'rebase' | 'squash';
export interface PackageRule extends RenovateSharedConfig, UpdateConfig, Record<string, any> {
    matchFiles?: string[];
    matchPaths?: string[];
