...
const managerValidator = (0, tslib_1.__importStar)(require("./validation-helpers/managers"));
            ...
            if (!optionTypes[key]) {
                ...
                if (type === 'boolean') {
                    ...
                    if (is_1.default.array(val)) {
                        ...
                        if (key === 'extends') {
                            const tzRe = (0, regex_1.regEx)(/^:timezone\((.+)\)$/); // TODO #12071
                        ...
                        if ((selectors.includes(key) || key === 'matchCurrentVersion') &&
                            !(0, regex_1.regEx)(/p.*Rules\[\d+\]$/).test(parentPath) && // Inside a packageRule  // TODO #12071
