...
export declare class AwsMachineImageDataSource extends Datasource {
    ...
    getDigest({ lookupName: serializedAmiFilter }: GetReleasesConfig, newValue?: string): Promise<string | null>;
    getReleases({ lookupName: serializedAmiFilter, }: GetReleasesConfig): Promise<ReleaseResult | null>;
}
