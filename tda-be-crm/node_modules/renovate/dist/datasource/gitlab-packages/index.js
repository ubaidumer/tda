...
class GitlabPackagesDatasource extends datasource_1.Datasource {
    constructor() {
        ...
        this.http = new gitlab_1.GitlabHttp();
    }
    ...
    async getReleases({ registryUrl, lookupName, }) {
        ...
        const apiUrl = GitlabPackagesDatasource.getGitlabPackageApiUrl(registryUrl, projectName, packageName);
        const result = {
            releases: null,
        };
        let response;
        ...
        return ((_a = result.releases) === null || _a === void 0 ? void 0 : _a.length) ? result : null;
    }
}
