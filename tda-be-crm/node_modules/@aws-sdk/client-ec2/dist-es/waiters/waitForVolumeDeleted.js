...
var checkState = function (client, input) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _d.trys.push([0, 2, , 3]);
                return [4, client.send(new DescribeVolumesCommand(input))];
            case 1:
                result_1 = _d.sent();
                reason = result_1;
                try {
                    returnComparator = function () {
                        var flat_1 = [].concat.apply([], __spreadArray([], __read(result_1.Volumes)));
            ...
            case 2:
                exception_1 = _d.sent();
                reason = exception_1;
                if (exception_1.name && exception_1.name == "InvalidVolume.NotFound") {
                    return [2, { state: WaiterState.SUCCESS, reason: reason }];
                }
                return [3, 3];
...
export var waitForVolumeDeleted = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
    var serviceDefaults;
...
export var waitUntilVolumeDeleted = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
...
//# sourceMappingURL=waitForVolumeDeleted.js.map