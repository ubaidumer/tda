...
var checkState = function (client, input) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _d.trys.push([0, 2, , 3]);
                return [4, client.send(new DescribeNetworkInterfacesCommand(input))];
            case 1:
                result_1 = _d.sent();
                reason = result_1;
                try {
                    returnComparator = function () {
                        var flat_1 = [].concat.apply([], __spreadArray([], __read(result_1.NetworkInterfaces)));
            ...
            case 2:
                exception_1 = _d.sent();
                reason = exception_1;
                if (exception_1.name && exception_1.name == "InvalidNetworkInterfaceID.NotFound") {
...
export var waitForNetworkInterfaceAvailable = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
    var serviceDefaults;
...
export var waitUntilNetworkInterfaceAvailable = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
...
//# sourceMappingURL=waitForNetworkInterfaceAvailable.js.map