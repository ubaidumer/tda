...
var checkState = function (client, input) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, client.send(new GetPasswordDataCommand(input))];
            case 1:
                result_1 = _a.sent();
                reason = result_1;
                try {
                    returnComparator = function () {
                        return result_1.PasswordData.length > 0.0;
                    };
...
export var waitForPasswordDataAvailable = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
    var serviceDefaults;
    return __generator(this, function (_a) {
...
export var waitUntilPasswordDataAvailable = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
