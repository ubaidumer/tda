...
var checkState = function (client, input) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_k) {
        switch (_k.label) {
            case 0:
                _k.trys.push([0, 2, , 3]);
                return [4, client.send(new DescribeCustomerGatewaysCommand(input))];
            case 1:
                result_1 = _k.sent();
                reason = result_1;
                try {
                    returnComparator = function () {
                        var flat_1 = [].concat.apply([], __spreadArray([], __read(result_1.CustomerGateways)));
...
export var waitForCustomerGatewayAvailable = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
    var serviceDefaults;
...
export var waitUntilCustomerGatewayAvailable = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
