...
var checkState = function (client, input) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, client.send(new DescribeVpcsCommand(input))];
            case 1:
                result = _a.sent();
                reason = result;
            ...
            case 2:
                exception_1 = _a.sent();
                reason = exception_1;
                if (exception_1.name && exception_1.name == "InvalidVpcID.NotFound") {
...
export var waitForVpcExists = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
    var serviceDefaults;
    return __generator(this, function (_a) {
...
export var waitUntilVpcExists = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
...
//# sourceMappingURL=waitForVpcExists.js.map