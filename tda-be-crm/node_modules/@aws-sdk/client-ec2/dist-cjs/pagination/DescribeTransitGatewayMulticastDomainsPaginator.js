...
exports.paginateDescribeTransitGatewayMulticastDomains = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeTransitGatewayMulticastDomainsCommand_1.DescribeTransitGatewayMulticastDomainsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeTransitGatewayMulticastDomains(config, input, ...additionalArguments) {
