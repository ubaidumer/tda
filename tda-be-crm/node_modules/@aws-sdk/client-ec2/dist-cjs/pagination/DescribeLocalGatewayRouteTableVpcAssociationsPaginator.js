...
exports.paginateDescribeLocalGatewayRouteTableVpcAssociations = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeLocalGatewayRouteTableVpcAssociationsCommand_1.DescribeLocalGatewayRouteTableVpcAssociationsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeLocalGatewayRouteTableVpcAssociations(config, input, ...additionalArguments) {
