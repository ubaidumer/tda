...
exports.paginateDescribeCapacityReservations = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeCapacityReservationsCommand_1.DescribeCapacityReservationsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeCapacityReservations(config, input, ...additionalArguments) {
