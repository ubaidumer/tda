...
exports.paginateDescribeExportImageTasks = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeExportImageTasksCommand_1.DescribeExportImageTasksCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeExportImageTasks(config, input, ...additionalArguments) {
