...
exports.paginateDescribeNetworkInsightsPaths = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeNetworkInsightsPathsCommand_1.DescribeNetworkInsightsPathsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeNetworkInsightsPaths(config, input, ...additionalArguments) {
