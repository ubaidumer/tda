...
exports.paginateGetTransitGatewayRouteTablePropagations = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new GetTransitGatewayRouteTablePropagationsCommand_1.GetTransitGatewayRouteTablePropagationsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateGetTransitGatewayRouteTablePropagations(config, input, ...additionalArguments) {
