...
exports.paginateDescribeInternetGateways = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeInternetGatewaysCommand_1.DescribeInternetGatewaysCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeInternetGateways(config, input, ...additionalArguments) {
