...
exports.paginateDescribeDhcpOptions = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeDhcpOptionsCommand_1.DescribeDhcpOptionsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeDhcpOptions(config, input, ...additionalArguments) {
