...
exports.paginateDescribeLaunchTemplates = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeLaunchTemplatesCommand_1.DescribeLaunchTemplatesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeLaunchTemplates(config, input, ...additionalArguments) {
