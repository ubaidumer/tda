...
exports.paginateDescribeAddressesAttribute = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeAddressesAttributeCommand_1.DescribeAddressesAttributeCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeAddressesAttribute(config, input, ...additionalArguments) {
