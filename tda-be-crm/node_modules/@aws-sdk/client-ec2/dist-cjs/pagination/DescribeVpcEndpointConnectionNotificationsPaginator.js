...
exports.paginateDescribeVpcEndpointConnectionNotifications = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeVpcEndpointConnectionNotificationsCommand_1.DescribeVpcEndpointConnectionNotificationsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeVpcEndpointConnectionNotifications(config, input, ...additionalArguments) {
