...
exports.paginateDescribeMovingAddresses = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeMovingAddressesCommand_1.DescribeMovingAddressesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeMovingAddresses(config, input, ...additionalArguments) {
