...
exports.paginateDescribeClientVpnConnections = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeClientVpnConnectionsCommand_1.DescribeClientVpnConnectionsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeClientVpnConnections(config, input, ...additionalArguments) {
