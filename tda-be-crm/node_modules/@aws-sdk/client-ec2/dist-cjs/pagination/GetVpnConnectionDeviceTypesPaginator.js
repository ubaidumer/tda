...
exports.paginateGetVpnConnectionDeviceTypes = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new GetVpnConnectionDeviceTypesCommand_1.GetVpnConnectionDeviceTypesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateGetVpnConnectionDeviceTypes(config, input, ...additionalArguments) {
