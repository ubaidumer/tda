...
exports.paginateDescribeSpotFleetRequests = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeSpotFleetRequestsCommand_1.DescribeSpotFleetRequestsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeSpotFleetRequests(config, input, ...additionalArguments) {
