...
exports.paginateDescribeHostReservations = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeHostReservationsCommand_1.DescribeHostReservationsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeHostReservations(config, input, ...additionalArguments) {
