...
exports.paginateGetManagedPrefixListEntries = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new GetManagedPrefixListEntriesCommand_1.GetManagedPrefixListEntriesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateGetManagedPrefixListEntries(config, input, ...additionalArguments) {
