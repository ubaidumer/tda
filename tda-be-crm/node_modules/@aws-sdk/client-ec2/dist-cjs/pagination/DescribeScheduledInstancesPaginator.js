...
exports.paginateDescribeScheduledInstances = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeScheduledInstancesCommand_1.DescribeScheduledInstancesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeScheduledInstances(config, input, ...additionalArguments) {
