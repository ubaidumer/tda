...
exports.paginateDescribeVpcEndpoints = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeVpcEndpointsCommand_1.DescribeVpcEndpointsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeVpcEndpoints(config, input, ...additionalArguments) {
