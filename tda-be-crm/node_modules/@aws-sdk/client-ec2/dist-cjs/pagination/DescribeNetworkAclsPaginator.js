...
exports.paginateDescribeNetworkAcls = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeNetworkAclsCommand_1.DescribeNetworkAclsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeNetworkAcls(config, input, ...additionalArguments) {
