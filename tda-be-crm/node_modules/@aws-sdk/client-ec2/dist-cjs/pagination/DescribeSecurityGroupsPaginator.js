...
exports.paginateDescribeSecurityGroups = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeSecurityGroupsCommand_1.DescribeSecurityGroupsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeSecurityGroups(config, input, ...additionalArguments) {
