...
exports.paginateDescribeClassicLinkInstances = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeClassicLinkInstancesCommand_1.DescribeClassicLinkInstancesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeClassicLinkInstances(config, input, ...additionalArguments) {
