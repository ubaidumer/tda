...
exports.paginateDescribeTransitGatewayVpcAttachments = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeTransitGatewayVpcAttachmentsCommand_1.DescribeTransitGatewayVpcAttachmentsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeTransitGatewayVpcAttachments(config, input, ...additionalArguments) {
