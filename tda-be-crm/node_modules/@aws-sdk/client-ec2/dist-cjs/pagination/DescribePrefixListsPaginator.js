...
exports.paginateDescribePrefixLists = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribePrefixListsCommand_1.DescribePrefixListsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribePrefixLists(config, input, ...additionalArguments) {
