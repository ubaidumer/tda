...
exports.paginateDescribeVpcs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeVpcsCommand_1.DescribeVpcsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeVpcs(config, input, ...additionalArguments) {
