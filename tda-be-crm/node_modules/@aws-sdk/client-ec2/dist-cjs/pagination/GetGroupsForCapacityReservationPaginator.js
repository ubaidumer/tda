...
exports.paginateGetGroupsForCapacityReservation = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new GetGroupsForCapacityReservationCommand_1.GetGroupsForCapacityReservationCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateGetGroupsForCapacityReservation(config, input, ...additionalArguments) {
