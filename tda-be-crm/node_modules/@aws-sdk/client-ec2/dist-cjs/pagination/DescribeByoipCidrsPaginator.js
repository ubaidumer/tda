...
exports.paginateDescribeByoipCidrs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeByoipCidrsCommand_1.DescribeByoipCidrsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeByoipCidrs(config, input, ...additionalArguments) {
