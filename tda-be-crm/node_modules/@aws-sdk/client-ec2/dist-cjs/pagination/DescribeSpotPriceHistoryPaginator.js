...
exports.paginateDescribeSpotPriceHistory = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeSpotPriceHistoryCommand_1.DescribeSpotPriceHistoryCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeSpotPriceHistory(config, input, ...additionalArguments) {
