...
exports.paginateDescribeFlowLogs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeFlowLogsCommand_1.DescribeFlowLogsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeFlowLogs(config, input, ...additionalArguments) {
