...
exports.paginateDescribeScheduledInstanceAvailability = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeScheduledInstanceAvailabilityCommand_1.DescribeScheduledInstanceAvailabilityCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeScheduledInstanceAvailability(config, input, ...additionalArguments) {
