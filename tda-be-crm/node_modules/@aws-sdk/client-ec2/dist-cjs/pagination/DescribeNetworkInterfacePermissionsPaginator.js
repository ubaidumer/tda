...
exports.paginateDescribeNetworkInterfacePermissions = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeNetworkInterfacePermissionsCommand_1.DescribeNetworkInterfacePermissionsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeNetworkInterfacePermissions(config, input, ...additionalArguments) {
