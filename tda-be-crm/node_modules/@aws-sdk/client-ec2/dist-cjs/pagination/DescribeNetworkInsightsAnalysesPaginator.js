...
exports.paginateDescribeNetworkInsightsAnalyses = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeNetworkInsightsAnalysesCommand_1.DescribeNetworkInsightsAnalysesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeNetworkInsightsAnalyses(config, input, ...additionalArguments) {
