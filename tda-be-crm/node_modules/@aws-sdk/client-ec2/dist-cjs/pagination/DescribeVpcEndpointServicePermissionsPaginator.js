...
exports.paginateDescribeVpcEndpointServicePermissions = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeVpcEndpointServicePermissionsCommand_1.DescribeVpcEndpointServicePermissionsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeVpcEndpointServicePermissions(config, input, ...additionalArguments) {
