...
exports.paginateDescribeVpcEndpointConnections = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeVpcEndpointConnectionsCommand_1.DescribeVpcEndpointConnectionsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeVpcEndpointConnections(config, input, ...additionalArguments) {
