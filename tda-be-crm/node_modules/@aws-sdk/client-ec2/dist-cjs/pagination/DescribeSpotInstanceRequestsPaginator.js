...
exports.paginateDescribeSpotInstanceRequests = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeSpotInstanceRequestsCommand_1.DescribeSpotInstanceRequestsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeSpotInstanceRequests(config, input, ...additionalArguments) {
