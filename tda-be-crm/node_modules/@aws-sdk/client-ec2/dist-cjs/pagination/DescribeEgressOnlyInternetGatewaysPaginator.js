...
exports.paginateDescribeEgressOnlyInternetGateways = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeEgressOnlyInternetGatewaysCommand_1.DescribeEgressOnlyInternetGatewaysCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeEgressOnlyInternetGateways(config, input, ...additionalArguments) {
