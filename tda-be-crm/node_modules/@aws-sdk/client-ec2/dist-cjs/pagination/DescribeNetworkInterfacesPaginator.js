...
exports.paginateDescribeNetworkInterfaces = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeNetworkInterfacesCommand_1.DescribeNetworkInterfacesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeNetworkInterfaces(config, input, ...additionalArguments) {
