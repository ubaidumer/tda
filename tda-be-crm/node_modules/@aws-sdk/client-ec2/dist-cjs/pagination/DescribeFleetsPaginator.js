...
exports.paginateDescribeFleets = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeFleetsCommand_1.DescribeFleetsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeFleets(config, input, ...additionalArguments) {
