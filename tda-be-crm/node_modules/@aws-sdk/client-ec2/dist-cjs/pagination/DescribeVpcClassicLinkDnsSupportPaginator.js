...
exports.paginateDescribeVpcClassicLinkDnsSupport = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeVpcClassicLinkDnsSupportCommand_1.DescribeVpcClassicLinkDnsSupportCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeVpcClassicLinkDnsSupport(config, input, ...additionalArguments) {
