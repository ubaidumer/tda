...
exports.paginateDescribeLocalGatewayRouteTables = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeLocalGatewayRouteTablesCommand_1.DescribeLocalGatewayRouteTablesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeLocalGatewayRouteTables(config, input, ...additionalArguments) {
