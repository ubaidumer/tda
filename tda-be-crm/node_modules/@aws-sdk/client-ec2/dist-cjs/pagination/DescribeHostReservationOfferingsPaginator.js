...
exports.paginateDescribeHostReservationOfferings = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeHostReservationOfferingsCommand_1.DescribeHostReservationOfferingsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeHostReservationOfferings(config, input, ...additionalArguments) {
