...
exports.paginateGetManagedPrefixListAssociations = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new GetManagedPrefixListAssociationsCommand_1.GetManagedPrefixListAssociationsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateGetManagedPrefixListAssociations(config, input, ...additionalArguments) {
