...
exports.paginateDescribeImportImageTasks = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeImportImageTasksCommand_1.DescribeImportImageTasksCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeImportImageTasks(config, input, ...additionalArguments) {
