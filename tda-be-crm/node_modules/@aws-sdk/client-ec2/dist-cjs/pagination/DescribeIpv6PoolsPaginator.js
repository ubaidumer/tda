...
exports.paginateDescribeIpv6Pools = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeIpv6PoolsCommand_1.DescribeIpv6PoolsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeIpv6Pools(config, input, ...additionalArguments) {
