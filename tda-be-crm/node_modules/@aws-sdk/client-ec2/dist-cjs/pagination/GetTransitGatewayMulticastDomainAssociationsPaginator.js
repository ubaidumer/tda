...
exports.paginateGetTransitGatewayMulticastDomainAssociations = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new GetTransitGatewayMulticastDomainAssociationsCommand_1.GetTransitGatewayMulticastDomainAssociationsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateGetTransitGatewayMulticastDomainAssociations(config, input, ...additionalArguments) {
