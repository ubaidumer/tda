...
exports.paginateDescribeCarrierGateways = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeCarrierGatewaysCommand_1.DescribeCarrierGatewaysCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeCarrierGateways(config, input, ...additionalArguments) {
