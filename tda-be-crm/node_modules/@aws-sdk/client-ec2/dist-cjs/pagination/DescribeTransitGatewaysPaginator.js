...
exports.paginateDescribeTransitGateways = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeTransitGatewaysCommand_1.DescribeTransitGatewaysCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeTransitGateways(config, input, ...additionalArguments) {
