...
exports.paginateDescribeClientVpnRoutes = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeClientVpnRoutesCommand_1.DescribeClientVpnRoutesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeClientVpnRoutes(config, input, ...additionalArguments) {
