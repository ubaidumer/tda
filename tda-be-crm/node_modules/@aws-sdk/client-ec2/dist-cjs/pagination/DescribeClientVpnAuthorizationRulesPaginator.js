...
exports.paginateDescribeClientVpnAuthorizationRules = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeClientVpnAuthorizationRulesCommand_1.DescribeClientVpnAuthorizationRulesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeClientVpnAuthorizationRules(config, input, ...additionalArguments) {
