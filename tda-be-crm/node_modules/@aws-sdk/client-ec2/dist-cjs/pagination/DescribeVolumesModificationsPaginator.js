...
exports.paginateDescribeVolumesModifications = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeVolumesModificationsCommand_1.DescribeVolumesModificationsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeVolumesModifications(config, input, ...additionalArguments) {
