...
exports.paginateDescribeLocalGatewayVirtualInterfaces = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeLocalGatewayVirtualInterfacesCommand_1.DescribeLocalGatewayVirtualInterfacesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeLocalGatewayVirtualInterfaces(config, input, ...additionalArguments) {
