...
exports.paginateDescribeSubnets = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeSubnetsCommand_1.DescribeSubnetsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeSubnets(config, input, ...additionalArguments) {
