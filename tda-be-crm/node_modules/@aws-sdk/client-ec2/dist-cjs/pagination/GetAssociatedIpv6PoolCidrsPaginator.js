...
exports.paginateGetAssociatedIpv6PoolCidrs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new GetAssociatedIpv6PoolCidrsCommand_1.GetAssociatedIpv6PoolCidrsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateGetAssociatedIpv6PoolCidrs(config, input, ...additionalArguments) {
