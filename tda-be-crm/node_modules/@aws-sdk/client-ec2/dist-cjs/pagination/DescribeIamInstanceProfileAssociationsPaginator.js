...
exports.paginateDescribeIamInstanceProfileAssociations = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeIamInstanceProfileAssociationsCommand_1.DescribeIamInstanceProfileAssociationsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeIamInstanceProfileAssociations(config, input, ...additionalArguments) {
