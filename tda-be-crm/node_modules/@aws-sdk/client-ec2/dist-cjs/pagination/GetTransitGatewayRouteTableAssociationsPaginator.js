...
exports.paginateGetTransitGatewayRouteTableAssociations = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new GetTransitGatewayRouteTableAssociationsCommand_1.GetTransitGatewayRouteTableAssociationsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateGetTransitGatewayRouteTableAssociations(config, input, ...additionalArguments) {
