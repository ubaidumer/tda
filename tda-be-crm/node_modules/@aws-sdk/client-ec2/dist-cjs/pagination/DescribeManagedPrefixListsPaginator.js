...
exports.paginateDescribeManagedPrefixLists = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeManagedPrefixListsCommand_1.DescribeManagedPrefixListsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeManagedPrefixLists(config, input, ...additionalArguments) {
