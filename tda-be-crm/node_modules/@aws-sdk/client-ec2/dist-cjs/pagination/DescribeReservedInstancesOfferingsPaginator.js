...
exports.paginateDescribeReservedInstancesOfferings = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeReservedInstancesOfferingsCommand_1.DescribeReservedInstancesOfferingsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeReservedInstancesOfferings(config, input, ...additionalArguments) {
