...
exports.paginateDescribeVpcPeeringConnections = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeVpcPeeringConnectionsCommand_1.DescribeVpcPeeringConnectionsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeVpcPeeringConnections(config, input, ...additionalArguments) {
