...
exports.paginateDescribeFastSnapshotRestores = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeFastSnapshotRestoresCommand_1.DescribeFastSnapshotRestoresCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeFastSnapshotRestores(config, input, ...additionalArguments) {
