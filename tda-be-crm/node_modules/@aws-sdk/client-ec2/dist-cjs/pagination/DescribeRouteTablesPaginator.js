...
exports.paginateDescribeRouteTables = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeRouteTablesCommand_1.DescribeRouteTablesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeRouteTables(config, input, ...additionalArguments) {
