...
exports.paginateDescribeCoipPools = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeCoipPoolsCommand_1.DescribeCoipPoolsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeCoipPools(config, input, ...additionalArguments) {
