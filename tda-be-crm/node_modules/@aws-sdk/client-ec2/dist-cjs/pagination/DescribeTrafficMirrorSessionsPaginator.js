...
exports.paginateDescribeTrafficMirrorSessions = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeTrafficMirrorSessionsCommand_1.DescribeTrafficMirrorSessionsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeTrafficMirrorSessions(config, input, ...additionalArguments) {
