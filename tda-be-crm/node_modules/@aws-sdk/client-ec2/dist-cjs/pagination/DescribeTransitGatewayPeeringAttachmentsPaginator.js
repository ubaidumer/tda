...
exports.paginateDescribeTransitGatewayPeeringAttachments = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeTransitGatewayPeeringAttachmentsCommand_1.DescribeTransitGatewayPeeringAttachmentsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeTransitGatewayPeeringAttachments(config, input, ...additionalArguments) {
