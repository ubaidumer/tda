...
exports.paginateDescribeFpgaImages = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeFpgaImagesCommand_1.DescribeFpgaImagesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeFpgaImages(config, input, ...additionalArguments) {
