...
exports.paginateDescribeInstanceStatus = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeInstanceStatusCommand_1.DescribeInstanceStatusCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeInstanceStatus(config, input, ...additionalArguments) {
