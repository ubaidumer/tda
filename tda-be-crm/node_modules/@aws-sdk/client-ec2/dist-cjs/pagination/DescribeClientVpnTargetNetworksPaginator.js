...
exports.paginateDescribeClientVpnTargetNetworks = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeClientVpnTargetNetworksCommand_1.DescribeClientVpnTargetNetworksCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeClientVpnTargetNetworks(config, input, ...additionalArguments) {
