...
exports.paginateDescribeTransitGatewayRouteTables = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeTransitGatewayRouteTablesCommand_1.DescribeTransitGatewayRouteTablesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeTransitGatewayRouteTables(config, input, ...additionalArguments) {
