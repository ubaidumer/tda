...
exports.waitUntilInstanceStatusOk = exports.waitForInstanceStatusOk = void 0;
const util_waiter_1 = require("@aws-sdk/util-waiter");
const DescribeInstanceStatusCommand_1 = require("../commands/DescribeInstanceStatusCommand");
const checkState = async (client, input) => {
    let reason;
    try {
        const result = await client.send(new DescribeInstanceStatusCommand_1.DescribeInstanceStatusCommand(input));
        reason = result;
        try {
