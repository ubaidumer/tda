...
exports.waitUntilVpnConnectionAvailable = exports.waitForVpnConnectionAvailable = void 0;
const util_waiter_1 = require("@aws-sdk/util-waiter");
const DescribeVpnConnectionsCommand_1 = require("../commands/DescribeVpnConnectionsCommand");
const checkState = async (client, input) => {
    let reason;
    try {
        const result = await client.send(new DescribeVpnConnectionsCommand_1.DescribeVpnConnectionsCommand(input));
        reason = result;
        try {
