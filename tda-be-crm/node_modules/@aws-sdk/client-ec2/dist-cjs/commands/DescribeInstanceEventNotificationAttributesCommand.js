...
exports.DescribeInstanceEventNotificationAttributesCommand = void 0;
 ...
 *
 */
class DescribeInstanceEventNotificationAttributesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_3_1.DescribeInstanceEventNotificationAttributesRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_3_1.DescribeInstanceEventNotificationAttributesResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2DescribeInstanceEventNotificationAttributesCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2DescribeInstanceEventNotificationAttributesCommand(output, context);
    }
}
