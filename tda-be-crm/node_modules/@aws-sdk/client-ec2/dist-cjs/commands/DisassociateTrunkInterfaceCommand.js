...
exports.DisassociateTrunkInterfaceCommand = void 0;
 ...
 *
 */
class DisassociateTrunkInterfaceCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_4_1.DisassociateTrunkInterfaceRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_4_1.DisassociateTrunkInterfaceResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2DisassociateTrunkInterfaceCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2DisassociateTrunkInterfaceCommand(output, context);
    }
}
exports.DisassociateTrunkInterfaceCommand = DisassociateTrunkInterfaceCommand;
//# sourceMappingURL=DisassociateTrunkInterfaceCommand.js.map