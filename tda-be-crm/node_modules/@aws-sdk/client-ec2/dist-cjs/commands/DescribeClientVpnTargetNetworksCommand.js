...
exports.DescribeClientVpnTargetNetworksCommand = void 0;
 ...
 *
 */
class DescribeClientVpnTargetNetworksCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_2_1.DescribeClientVpnTargetNetworksRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_2_1.DescribeClientVpnTargetNetworksResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2DescribeClientVpnTargetNetworksCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2DescribeClientVpnTargetNetworksCommand(output, context);
    }
}
