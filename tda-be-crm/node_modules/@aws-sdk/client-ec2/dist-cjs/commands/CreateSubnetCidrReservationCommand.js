...
exports.CreateSubnetCidrReservationCommand = void 0;
...
class CreateSubnetCidrReservationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.CreateSubnetCidrReservationRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.CreateSubnetCidrReservationResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2CreateSubnetCidrReservationCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2CreateSubnetCidrReservationCommand(output, context);
    }
}
exports.CreateSubnetCidrReservationCommand = CreateSubnetCidrReservationCommand;
//# sourceMappingURL=CreateSubnetCidrReservationCommand.js.map