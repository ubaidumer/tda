...
exports.CreateLaunchTemplateVersionCommand = void 0;
 ...
 *
 */
class CreateLaunchTemplateVersionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.CreateLaunchTemplateVersionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.CreateLaunchTemplateVersionResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2CreateLaunchTemplateVersionCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2CreateLaunchTemplateVersionCommand(output, context);
    }
}
