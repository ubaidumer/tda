...
exports.StartNetworkInsightsAnalysisCommand = void 0;
 ...
 *
 */
class StartNetworkInsightsAnalysisCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_5_1.StartNetworkInsightsAnalysisRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_5_1.StartNetworkInsightsAnalysisResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2StartNetworkInsightsAnalysisCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2StartNetworkInsightsAnalysisCommand(output, context);
    }
}
