...
class ModifyVpnTunnelCertificateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_5_1.ModifyVpnTunnelCertificateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_5_1.ModifyVpnTunnelCertificateResult.filterSensitiveLog,
        };
