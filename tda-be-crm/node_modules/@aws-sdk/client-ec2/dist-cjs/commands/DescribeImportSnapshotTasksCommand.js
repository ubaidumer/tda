...
exports.DescribeImportSnapshotTasksCommand = void 0;
...
class DescribeImportSnapshotTasksCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_2_1.DescribeImportSnapshotTasksRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_2_1.DescribeImportSnapshotTasksResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2DescribeImportSnapshotTasksCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2DescribeImportSnapshotTasksCommand(output, context);
    }
}
exports.DescribeImportSnapshotTasksCommand = DescribeImportSnapshotTasksCommand;
//# sourceMappingURL=DescribeImportSnapshotTasksCommand.js.map