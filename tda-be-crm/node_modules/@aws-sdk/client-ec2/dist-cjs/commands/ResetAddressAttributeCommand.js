...
exports.ResetAddressAttributeCommand = void 0;
 ...
 *
 */
class ResetAddressAttributeCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_5_1.ResetAddressAttributeRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_5_1.ResetAddressAttributeResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2ResetAddressAttributeCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2ResetAddressAttributeCommand(output, context);
    }
}
exports.ResetAddressAttributeCommand = ResetAddressAttributeCommand;
//# sourceMappingURL=ResetAddressAttributeCommand.js.map