...
exports.DeleteTrafficMirrorSessionCommand = void 0;
 ...
 *
 */
class DeleteTrafficMirrorSessionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_2_1.DeleteTrafficMirrorSessionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_2_1.DeleteTrafficMirrorSessionResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2DeleteTrafficMirrorSessionCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2DeleteTrafficMirrorSessionCommand(output, context);
    }
}
exports.DeleteTrafficMirrorSessionCommand = DeleteTrafficMirrorSessionCommand;
//# sourceMappingURL=DeleteTrafficMirrorSessionCommand.js.map