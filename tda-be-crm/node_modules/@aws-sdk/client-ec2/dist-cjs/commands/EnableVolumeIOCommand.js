...
exports.EnableVolumeIOCommand = void 0;
 ...
 *
 */
class EnableVolumeIOCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_4_1.EnableVolumeIORequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2EnableVolumeIOCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2EnableVolumeIOCommand(output, context);
    }
}
