...
exports.DeleteVpnConnectionRouteCommand = void 0;
 ...
 *
 */
class DeleteVpnConnectionRouteCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_2_1.DeleteVpnConnectionRouteRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2DeleteVpnConnectionRouteCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2DeleteVpnConnectionRouteCommand(output, context);
    }
}
