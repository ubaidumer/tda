...
exports.DescribeNetworkInsightsAnalysesCommand = void 0;
 ...
 *
 */
class DescribeNetworkInsightsAnalysesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_3_1.DescribeNetworkInsightsAnalysesRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_3_1.DescribeNetworkInsightsAnalysesResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2DescribeNetworkInsightsAnalysesCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2DescribeNetworkInsightsAnalysesCommand(output, context);
    }
}
