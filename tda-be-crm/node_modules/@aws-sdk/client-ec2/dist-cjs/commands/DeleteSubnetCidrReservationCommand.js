...
exports.DeleteSubnetCidrReservationCommand = void 0;
 ...
 *
 */
class DeleteSubnetCidrReservationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_2_1.DeleteSubnetCidrReservationRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_2_1.DeleteSubnetCidrReservationResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2DeleteSubnetCidrReservationCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2DeleteSubnetCidrReservationCommand(output, context);
    }
}
exports.DeleteSubnetCidrReservationCommand = DeleteSubnetCidrReservationCommand;
//# sourceMappingURL=DeleteSubnetCidrReservationCommand.js.map