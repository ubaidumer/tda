...
exports.ModifySecurityGroupRulesCommand = void 0;
 ...
 *
 */
class ModifySecurityGroupRulesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_4_1.ModifySecurityGroupRulesRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_4_1.ModifySecurityGroupRulesResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2ModifySecurityGroupRulesCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2ModifySecurityGroupRulesCommand(output, context);
    }
}
exports.ModifySecurityGroupRulesCommand = ModifySecurityGroupRulesCommand;
//# sourceMappingURL=ModifySecurityGroupRulesCommand.js.map