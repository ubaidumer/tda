...
exports.DetachNetworkInterfaceCommand = void 0;
 ...
 *
 */
class DetachNetworkInterfaceCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_4_1.DetachNetworkInterfaceRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2DetachNetworkInterfaceCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2DetachNetworkInterfaceCommand(output, context);
    }
}
