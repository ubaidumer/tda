...
exports.ModifyFpgaImageAttributeCommand = void 0;
 ...
 *
 */
class ModifyFpgaImageAttributeCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_4_1.ModifyFpgaImageAttributeRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_4_1.ModifyFpgaImageAttributeResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2ModifyFpgaImageAttributeCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2ModifyFpgaImageAttributeCommand(output, context);
    }
}
