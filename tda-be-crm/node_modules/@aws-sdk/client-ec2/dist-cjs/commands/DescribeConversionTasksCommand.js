...
exports.DescribeConversionTasksCommand = void 0;
...
class DescribeConversionTasksCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_2_1.DescribeConversionTasksRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_2_1.DescribeConversionTasksResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_ec2_1.serializeAws_ec2DescribeConversionTasksCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_ec2_1.deserializeAws_ec2DescribeConversionTasksCommand(output, context);
    }
}
exports.DescribeConversionTasksCommand = DescribeConversionTasksCommand;
//# sourceMappingURL=DescribeConversionTasksCommand.js.map