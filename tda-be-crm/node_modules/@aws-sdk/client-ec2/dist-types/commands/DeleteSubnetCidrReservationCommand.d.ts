 ...
 *
 */
export declare class DeleteSubnetCidrReservationCommand extends $Command<DeleteSubnetCidrReservationCommandInput, DeleteSubnetCidrReservationCommandOutput, EC2ClientResolvedConfig> {
    readonly input: DeleteSubnetCidrReservationCommandInput;
    constructor(input: DeleteSubnetCidrReservationCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: EC2ClientResolvedConfig, options?: __HttpHandlerOptions): Handler<DeleteSubnetCidrReservationCommandInput, DeleteSubnetCidrReservationCommandOutput>;
    private serialize;
    private deserialize;
}
