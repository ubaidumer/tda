import { _InstanceType, ActiveInstance, ActivityStatus, AllocationStrategy, AlternatePathHint, AttachmentStatus, AttributeValue, BatchState, BlockDeviceMapping, CurrencyCodeValues, FleetLaunchTemplateSpecification, FleetType, IamInstanceProfile, IamInstanceProfileSpecification, InstanceEventWindow, IpPermission, Placement, PlatformValues, ReservedInstancesListing, ResourceType, SecurityGroupRule, Subnet, Tag, TagSpecification, Tenancy, TransitGatewayAssociationState, TransitGatewayAttachmentResourceType, TransitGatewayAttachmentState, TransitGatewayPeeringAttachment, TransitGatewayVpcAttachment, TrunkInterfaceAssociation, UserIdGroupPair, VolumeType } from "./models_0";
import { CapacityReservationPreference, CapacityReservationTargetResponse, GroupIdentifier, InstanceInterruptionBehavior, InstanceIpv6Address, InternetGateway, Ipv4PrefixSpecificationRequest, Ipv6PrefixSpecificationRequest, KeyType, LaunchTemplate, LaunchTemplateVersion, LocalGatewayRouteTableVpcAssociation, ManagedPrefixList, NatGateway, NetworkAcl, NetworkInsightsPath, NetworkInterface, NetworkInterfaceAttachment, NetworkInterfacePermission, NetworkInterfaceStatus, PlacementGroup, PortRange, PrivateIpAddressSpecification, ReplaceRootVolumeTask, RouteTable, Snapshot, SpotDatafeedSubscription, SpotInstanceStateFault, SpotInstanceType, TrafficMirrorFilter, TrafficMirrorSession, TrafficMirrorTarget, TransitGateway, TransitGatewayConnect, TransitGatewayConnectPeer, TransitGatewayMulticastDomain, TransitGatewayRouteTable, Volume } from "./models_1";
import { ArchitectureValues, AttributeBooleanValue, BootModeValues, DeviceType, EnclaveOptions, EventInformation, Filter, HypervisorType, IdFormat, InstanceBlockDeviceMapping, InstanceTagNotificationAttribute, PermissionGroup, ProductCode, StateReason, VirtualizationType } from "./models_2";
...
export declare type ArchitectureType = "arm64" | "i386" | "x86_64";
/**
