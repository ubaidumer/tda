import { _InstanceType, AddPrefixListEntry, AddressAttribute, Affinity, AllowedPrincipal, ApplianceModeSupportValue, AssociationStatus, AttributeValue, AutoPlacement, CapacityReservationState, ClientConnectOptions, ConnectionLogOptions, CurrencyCodeValues, DiskImageFormat, DnsSupportValue, EndDateType, FleetExcessCapacityTerminationPolicy, FleetLaunchTemplateConfigRequest, HostRecovery, IamInstanceProfileAssociation, InstanceEventWindow, InstanceEventWindowTimeRangeRequest, Ipv6SupportValue, Placement, PlatformValues, SelfServicePortal, SubnetAssociation, SubnetIpv6CidrBlockAssociation, Tag, TagSpecification, TargetCapacitySpecificationRequest, TargetConfigurationRequest, TransitGatewayAssociation, TransitGatewayAssociationState, TransitGatewayAttachmentResourceType, TransitGatewayMulticastDomainAssociations, TransitGatewayVpcAttachment, UnsuccessfulItem, VolumeType, Vpc, VpcCidrBlockAssociation, VpcIpv6CidrBlockAssociation, VpcPeeringConnection } from "./models_0";
import { AutoAcceptSharedAttachmentsValue, CapacityReservationPreference, CapacityReservationTarget, ConnectionNotification, DefaultRouteTableAssociationValue, DefaultRouteTablePropagationValue, DnsEntry, DnsNameState, LaunchTemplate, ManagedPrefixList, ResponseLaunchTemplateData, ServiceConfiguration, ServiceTypeDetail, ShutdownBehavior, State, SubnetCidrReservation, TrafficDirection, TrafficMirrorFilter, TrafficMirrorFilterRule, TrafficMirrorNetworkService, TrafficMirrorPortRangeRequest, TrafficMirrorRuleAction, TrafficMirrorSession, TransitGateway, TransitGatewayPrefixListReference, VpcEndpoint, VpnConnection, VpnEcmpSupportValue, VpnGateway } from "./models_1";
import { ArchitectureValues, AttributeBooleanValue, BootModeValues, ConversionTask, ExportTaskS3Location, FastSnapshotRestoreStateCode, Filter, FpgaImageAttribute, FpgaImageAttributeName, ImportImageLicenseConfigurationResponse, InstanceAttributeName, LaunchPermission, PaymentOption, PermissionGroup, SnapshotDetail, SnapshotTaskDetail } from "./models_2";
import { CreateVolumePermission, ExcessCapacityTerminationPolicy, HttpTokensState, InstanceMetadataEndpointState, InstanceMetadataOptionsResponse, InstanceMetadataProtocolState, InstanceStatusEvent, LaunchTemplateConfig, ReservedInstancesConfiguration, SnapshotAttributeName, VolumeModification, VolumeStatusItem } from "./models_3";
