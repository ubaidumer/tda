...
import { GetHostnameTemplateOptions } from "./getHostnameTemplate";
import { GetResolvedPartitionOptions } from "./getResolvedPartition";
export declare type RegionHash = {
    [key: string]: Partial<Pick<RegionInfo, Exclude<keyof RegionInfo, "partition" | "path">>>;
};
