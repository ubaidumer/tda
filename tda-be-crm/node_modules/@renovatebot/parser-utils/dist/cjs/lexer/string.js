...
function exprTplStatesMap($, { tplEndToken, tplEnd }) {
    const rootState = {};
    const tplState = (0, rules_1.copyStateDefinition)($);
...
function configStrings(states, opts) {
    ...
    const $ = (0, rules_1.copyStateDefinition)(states.$);
    const strStates = {};
    ...
    opts.forEach((strOpt, strIdx) => {
        ...
        const strState = {
            ...
            [strValueToken]: rules_1.fallbackRule,
        };
    ...
    return (0, rules_1.sortStatesMap)(result);
}
