...
export declare type CommentOption = LineCommentOption | MultilineCommentOption;
export declare type OperatorOption = string;
...
export declare type TemplateOption = VariableTemplateOption | ExpressionTemplateOption;
...
export declare type LexerRule = StringRule | RegexRule | FallbackRule;
export declare type TokenName = string;
export declare type StateDefinition = Record<TokenName, LexerRule>;
...
export declare type Token = NewlineToken | WhitespaceToken | BracketLeftToken | BracketRightToken | CommentToken | OperatorToken | StringStartToken | StringValueToken | StringEndToken | TemplateStartToken | TemplateEndToken | SymbolToken | NumberToken | UnknownToken | StartToken | EndToken;
export declare type MinorToken = NewlineToken | WhitespaceToken | CommentToken;
